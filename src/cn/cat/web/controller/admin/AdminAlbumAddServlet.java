...
/**
 * Servlet implementation class AdminAlbumAddServlet
 */
@WebServlet("/manag/album_add")
public class AdminAlbumAddServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private AlbumDao dao=(AlbumDao) DaoFactory.getInstance("albumDao");   
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminAlbumAddServlet() {
        super();
